...
if __name__ == '__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / f'strain_wise_w_SM_b_attn' / f'MDLM_MTR_fix_mean_wo_pad_eval_{num_ensembles}_fold_ensembles'
    ...
    for i, (strain_for_train, strain_for_test, test_group_name) in enumerate(zip(train_groups, test_groups, group_names)):
        ...
        pep_emb_dict = torch.load(current_directory / 'DataPrepare' / 'Data' / 'Pep_emb_dict_mean_wo_pad_eval.pt')
        SM_emb_dict = torch.load(current_directory / 'DataPrepare' / 'Data' / 'SM_emb_dict_mean_wo_pad_eval.pt')
