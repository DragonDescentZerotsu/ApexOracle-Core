...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_csv', type=str, help='Input CSV file path', default='/data2/tianang/projects/Synergy/DataPrepare/Data/small_molecule/processed/small_molecule_Evo_binary_data.csv')
    parser.add_argument('--output_csv', type=str, help='Output CSV file path', default='/data2/tianang/projects/Synergy/DataPrepare/Data/small_molecule/processed/small_molecule_Evo_binary_data_SELFIES.csv')
