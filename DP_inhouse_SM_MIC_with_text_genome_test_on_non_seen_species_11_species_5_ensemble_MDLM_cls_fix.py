...
if __name__ == '__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / f'11_species_w_SM' / f'MDLM_MTR_fix_cls_wo_pad_{num_ensembles}_fold_ensembles'
    ...
    # original_names_with_genome_embedding: 那些有对应 Evo2 embedding 的 DBAASP 中的完整 strain name
    ...
    Test R2: {r2:.6f}, genome text Test R2: {gt_r2:.6f}, text only Test R2: {t_r2:.6f}, Test train mean MIC R2: {r2_train_mean:.6f}""")
                ...
                with torch.no_grad():
                    ...
                    if r2_test > best_R2_test:
                        ...
                        }, model_save_dir / f'genome_text_learnable_emb_SM_Species_wise_best_R2_group_{args.test_group}_ensemble_{ensemble}.pth')
