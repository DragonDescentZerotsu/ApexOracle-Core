...
| Evo-2 | `/data2/tianang/projects/evo2`；官方上游 `53f1959` + local candidate `ccdbfbe` | `DragonDescentZerotsu/ApexOracle-Evo2`；`modules/evo2` | 通用 extraction CLI、9 CPU tests、567-FASTA plan-only、clean build/wheel smoke 已完成；40B runtime、public remote/fresh clone 待完成；禁止推送上游 |
