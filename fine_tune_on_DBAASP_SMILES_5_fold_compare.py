...
class CompareDataset(Dataset):
    ...
    def exclude_test_data(self, test_DBAASP_ids):
        """
...
if __name__=='__main__':
    ...
    wandb.init(
        ...
        project="Synergy",
        name=f'ChemBERTa_all_data_{num_epochs}epoch_{batch_size}batch size, L40S, compare only reversed PsudoMIC, all 0.5 fold change',
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)):
        ...
        compare_dataset = CompareDataset(
            ...
            tokenizer)
        # compare_dataset.exclude_test_data(test_subset_DBAASP_id)
        ...
        for epoch in range(num_epochs):
            ...
            for batch in tqdm(compare_loader, desc=f"Epoch {epoch + 1}/{num_epochs} | training comparison"):
                ...
                # final_loss = batch_attn_loss  # + psudo_MIC_loss
