...
data_path = '/home/tianang/Projects/Synergy/DataPrepare/Data/DBAASP_id_same_as_SMILES_AAseqs_bact_MICs_512_limit.csv'  # 替换为你的数据路
...
for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)): # TODO
    wandb.init(
        # set the wandb project where this run will be logged
        project="Synergy",
        name=f'APEX_all_data_{batch_size}batch_size',
