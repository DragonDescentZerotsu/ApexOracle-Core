...
class ClassificationModel(nn.Module):
    def __init__(self, model_name, num_labels):
        ...
        self.classifier = RegressionHead(self.bert.config.hidden_size)
...
if __name__=='__main__':
    ...
    data_path = '/home/tianang/Projects/Synergy/DataPrepare/Data/DBAASP_id_SMILES_bact_MICs.csv'  # 替换为你的数据路径
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)):
        ...
        # 加载模型
        model = ClassificationModel(model_name, num_labels=2)
        model.to(device)
