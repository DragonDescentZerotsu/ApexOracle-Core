...
model_save_dir = current_directory / 'Checkpoints' / 'genome' / '11_species' / f'{num_ensembles}_fold_ensembles'
...
for i, (grouped_species, grouped_strains, test_group_name) in enumerate(zip(all_grouped_species, all_grouped_strains, group_names)):
    ...
    for ensemble in tqdm(range(num_ensembles), desc=' Doing ensembles '):
        ...
        optimizer.add_param_group({'params': ChemBERTa_model.parameters(), 'lr': 1e-6})   # TODO: ChemBERTa 和别的学习率不一样
