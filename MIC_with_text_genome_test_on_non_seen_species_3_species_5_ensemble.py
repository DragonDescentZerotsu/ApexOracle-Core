...
num_ensembles = 25  # 要集成几个 model 来做预测
...
model_save_dir = current_directory / 'Checkpoints' / 'genome_text' / '3_species' / f'{num_ensembles}_fold_ensembles'
...
all_grouped_species = cluster_species(current_directory/'DataPrepare'/'Data'/'Genome'/'visualization'/'Serratia_replaced_tree_Fungi.phy', current_directory/'DataPrepare'/'Data'/'Genome'/'old_to_new_NCBI_taxonomy.json', num_clusters=num_clusters)
