...
- [x] 从 public legacy `ApexOracle/DLM_pretrain/` 准备
  ...
  不改模型结构、objective 或训练行为。public `main` `362ffcc`、tag `v0.1.0`、原始 recovery tag、
  5 source contracts、remote CI/fresh clone 和 H100 joint-objective smoke 均已通过。
