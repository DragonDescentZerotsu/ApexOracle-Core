#!/usr/bin/env python3
"""Prepare full capsule resources for the non-seen-strain MDLM-MTR result.

The script copies the raw data/embedding resources needed to reconstruct the
original split and writes optimizer-free copies of the 7-ensemble checkpoints.
Run this from the repository root before uploading the capsule.
"""
...
RESOURCE_DIRS = [
    ...
    ("DataPrepare/Data/Genome/ATCC", "DataPrepare/Data/Genome/ATCC"),
]

RESOURCE_FILES = [
    ("DataPrepare/Data/Pep_emb_dict.pt", "DataPrepare/Data/Pep_emb_dict.pt"),
    ("DataPrepare/Data/SM_emb_dict.pt", "DataPrepare/Data/SM_emb_dict.pt"),
    ("DataPrepare/Data/DBAASP_inhouse_AMP_SELFIES_token_MIC_Evo.csv", "DataPrepare/Data/DBAASP_inhouse_AMP_SELFIES_token_MIC_Evo.csv"),
    (
    ...
    ("DataPrepare/Data/Genome/old_to_new_NCBI_taxonomy.json", "DataPrepare/Data/Genome/old_to_new_NCBI_taxonomy.json"),
    (
...
CHECKPOINT_SRC = Path("Checkpoints/genome_text_learnable_emb/strain_wise_w_SM_b_attn/MDLM_MTR_fix_7_fold_ensembles")
CHECKPOINT_DST = Path("Checkpoints/genome_text_learnable_emb/strain_wise_w_SM_b_attn/MDLM_MTR_fix_7_fold_ensembles")
...
def run(args: argparse.Namespace) -> None:
    ...
    log_files = sorted(src_ckpt_dir.glob("*.log"))
    ...
    manifest_path = capsule_data / "non_seen_strains_mdlm_mtr_fix_resource_manifest.json"
