...
if __name__ == '__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / f'strain_wise_w_SM_b_attn' / f'MDLM_MTR_fix_cls_wo_pad_{num_ensembles}_fold_ensembles'
