...
class ClassificationModel(nn.Module):
    def __init__(self, model_name, num_labels):
        ...
        self.bert = AutoModel.from_pretrained(model_name, trust_remote_code=True)  # hidden_size = 768
...
if __name__=='__main__':
    ...
    wandb.init(
        ...
        project="Synergy",
        name=f'MolFormer_fix_{num_epochs}epoch_{batch_size}batch size, H100',
