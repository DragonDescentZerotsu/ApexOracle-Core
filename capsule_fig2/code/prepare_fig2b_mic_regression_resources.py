...
MODEL_RESOURCES = {
    ...
    "apex": {
        ...
        "checkpoint_source_dir": Path("Checkpoints/fig2b_baselines_online_5fold/apex"),
        "feature_file": "features.pt",
        "extra_files": ["metrics.json"],
        "description": "APEX frozen eval-mode encoder features with faithful online-trained 5-fold regression heads.",
    },
}
