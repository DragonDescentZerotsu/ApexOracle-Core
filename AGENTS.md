...
- **2026-08-09 作者确认、2026-08-10 修订的统一发布架构：** 最终公开发布直接把现有
  ...
  验收门槛见 `docs/UNIFIED_APEXORACLE_RELEASE_PLAN.md`。2026-08-10 现有 ApexOracle 已原地转换并发布；
  旧 active tree 由 branch `legacy-monorepo`
  和 annotated tag `legacy-monorepo-snapshot-2026-08-10` 双重固定到 `2f29dee9cf6b7750425414f66c1a2d67998cb87f`。
  Super-repo `v0.2.0` 已固定 Core `8c1def518ac148a878c14f4a39876db59649d43c`、DLM-Pretraining
  `362ffccac79bdd638a4e913c4f17df613da18f36`、MDLM `c9d17c7f6f091234aaaebf5f08dbe23542f980c1`、
  Evo-2 `2184211acda07b0d5ca865067174ac42f530ad04` 和 Generation
  `80d9a2cf9b0921f29e4a44edf5557ccac39f5af9` 五个 gitlinks；Core 不再 pending。完整 source archive、MIC
  quickstart 与 compact generation quickstart 均通过。未移动本地数据或训练权重；任何架构变更必须再次由
  作者确认并同步更新 canonical 计划与资产文档。
