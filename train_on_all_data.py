...
if __name__ == '__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / f'all_AMP_SM_data_train' / f'MDLM_MTR_fix_cls_wo_pad'
    ...
    for i, (strain_for_train, test_group_name) in enumerate(zip(train_groups, group_names)):
        ...
        t_strain_for_train = set(strain_for_train) & all_name_set
        t_train_data = []
        # t_test_data = []
    ...
    # Test R2: {r2:.6f}, genome text Test R2: {gt_r2:.6f}, text only Test R2: {t_r2:.6f}, Test train mean MIC R2: {r2_train_mean:.6f}""")
                ...
                if r2_train > best_R2_test:
                    ...
                    }, model_save_dir / f'all_data_best_R2_epoch_{epoch+1}.pth')
