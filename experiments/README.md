...
| `genome_condition_reviewer/` | 全 bacterial-embedding homologous-fragment variation 与 AMR/MGE fragment linear probes；弃用 controls 仅保留为本地审计历史 | `genome_condition_reviewer/README.md` |
