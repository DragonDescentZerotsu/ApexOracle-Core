...
if __name__=='__main__':
    ...
    wandb.init(
        ...
        project="Synergy",
        name=f'Synergy, LoRA, LoRA_r = {lora_r}, L40S, DBAASP only, co_cross_attn, no pretrain',
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(synergy_dataset)):
        ...
        cls_head = RegressionHead(ChemBERTa_model.config.hidden_size * 3, num_targets=3)
        cls_head.to(device)
